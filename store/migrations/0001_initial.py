# Generated by Django 3.0 on 2020-07-24 20:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('txn_id', models.CharField(max_length=30, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('category', models.CharField(choices=[('CS', 'Casual shoes'), ('FS', 'Formal shoes'), ('SS', 'Sports shoes')], max_length=2)),
                ('brand', models.CharField(choices=[('A', 'Addidas'), ('B', 'Bata'), ('M', 'Metro'), ('N', 'Nike'), ('R', 'Reboke')], max_length=1)),
